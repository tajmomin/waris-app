    ...
    <div className="space-y-6">
      ...
      >
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-xl bg-slate-900/90 hover:bg-slate-800 text-xs font-semibold text-slate-200 border border-slate-700 flex items-center gap-1.5 transition shrink-0"
        >
      ...
      {/* Audit Trail / Step-by-Step Jurisprudential Drawer */}
      {showAuditTrail && (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="glass-panel p-4 rounded-2xl border border-slate-800">
          ...
          <p className="text-[11px] text-slate-400 mt-0.5">
            {heirsList.length}{' '}
            {lang === 'ur' ? 'وارث گروپز' : 'Inheriting Heir Categories'}
          </p>
        </div>
      ...
      {/* Visual Chart & Summary Side-by-Side */}
      ...
      {/* Blocked / Excluded Heirs Alert (If any) */}
